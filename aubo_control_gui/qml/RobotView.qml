...
View3D {
    ...
    Node {
        ...
        RuntimeLoader { source: view.meshRoot + "/link0." + view.meshExtension; scale: Qt.vector3d(100,100,100); eulerRotation.x: 90 }
        Node {
            position: Qt.vector3d(0,0,16.3); eulerRotation.z: 180
            Node {
                eulerRotation.z: view.j1
                RuntimeLoader { source: view.meshRoot + "/link1." + view.meshExtension; scale: Qt.vector3d(100,100,100); eulerRotation.x: 90 }
                Node {
                    ...
                    Node {
                        ...
                        Node {
                            ...
                            Node {
                                ...
                                RuntimeLoader { source: view.meshRoot + "/link2." + view.meshExtension; scale: Qt.vector3d(100,100,100); eulerRotation.x: 90 }
                                Node {
                                    position: Qt.vector3d(48,0,0); eulerRotation.x: -180
                                    Node {
                                        eulerRotation.z: view.j3
                                        RuntimeLoader { source: view.meshRoot + "/link3." + view.meshExtension; scale: Qt.vector3d(100,100,100); eulerRotation.x: 90 }
                                        Node {
                                            ...
                                            Node {
                                                ...
                                                Node {
                                                    ...
                                                    RuntimeLoader { source: view.meshRoot + "/link4." + view.meshExtension; scale: Qt.vector3d(100,100,100); eulerRotation.x: 90 }
                                                    Node {
                                                        position: Qt.vector3d(0,11.75,0); eulerRotation.x: -90
                                                        Node {
                                                            eulerRotation.z: view.j5
                                                            RuntimeLoader { source: view.meshRoot + "/link5." + view.meshExtension; scale: Qt.vector3d(100,100,100); eulerRotation.x: 90 }
                                                            Node {
    ...
    Text { text: "AUBO i16 · 机械臂实时模型"; color: "#d7e8fa"; font.pixelSize: 21; x: 16; y: 14 }
