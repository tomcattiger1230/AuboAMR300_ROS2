...
新增 `rebar_onboard_rack.usda` 为四个料槽，每槽在 Y=±0.19 m 设两个弧形托座，中央留给夹爪。托座外侧保留内半径 17 mm、开口 140° 的弧形挡边，底部使用 ±30° 的 V 形承托面；钢筋最终中心高度为 0.715 m。基座底面保持 Z=0.602 m，将高度从 50 mm 增加到 95 mm，托座整体抬高 45 mm。料槽是 `base_link` 刚体下的碰撞子几何，跟随车体运动，不是悬空的世界固定物体。
